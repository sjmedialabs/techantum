...
export const blogArticles: BlogArticle[] = [
  {
    ...
    excerpt:
      'Explore how Next.js delivers faster load times, better SEO, and a superior developer experience for modern business websites.',
  ...
  },
  {
    ...
    excerpt:
      'Everything you need to know about multi-tenancy, subscription billing, user management, and cloud architecture for SaaS products.',
  ...
  },
  {
    ...
    excerpt:
      'A practical comparison of the two leading cross-platform mobile frameworks — performance, ecosystem, and real-world trade-offs.',
  ...
  },
  {
    ...
    excerpt:
      'Essential security measures every web app should implement — authentication, authorization, input validation, and HTTPS.',
  ...
  },
  {
    ...
    excerpt:
      'Step-by-step guide to defining features, choosing the right tech stack, and launching a minimum viable product quickly.',
  ...
  },
  {
    ...
    excerpt:
      'Core Web Vitals, image optimization, code splitting, and caching strategies to make your website blazing fast.',
  ...
  },
  {
    ...
    excerpt:
      'How to evaluate frameworks, databases, and cloud providers based on your team, budget, and product requirements.',
  ...
  },
  {
    ...
    excerpt:
      'Understanding sprints, demos, retrospectives, and how agile methodology keeps your project on track and transparent.',
  ...
  },
  {
    ...
    excerpt:
      'Payment gateways, inventory management, mobile checkout, and conversion optimization for online stores.',
  ...
  },
  {
    ...
    excerpt:
      'Why designing APIs first leads to better web apps, mobile apps, and third-party integrations.',
